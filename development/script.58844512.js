...
},{"../helpers/regeneratorRuntime":"../node_modules/@babel/runtime-corejs2/helpers/regeneratorRuntime.js"}],"../node_modules/core-js/library/modules/_object-to-array.js":[function(require,module,exports) {
var DESCRIPTORS = require('./_descriptors');
var getKeys = require('./_object-keys');
var toIObject = require('./_to-iobject');
...
},{"core-js/library/fn/object/values":"../node_modules/core-js/library/fn/object/values.js"}],"../node_modules/parcel-bundler/src/builtins/bundle-url.js":[function(require,module,exports) {
var bundleURL = null;
...
},{"./../../public/assets/images/logo.png":[["logo.3f4a1874.png","assets/images/logo.png"],"assets/images/logo.png"],"./../../public/assets/images/slider-images/phones.png":[["phones.7b13fa17.png","assets/images/slider-images/phones.png"],"assets/images/slider-images/phones.png"],"./../../public/assets/images/slider-images/slider-1.png":[["slider-1.259b9e0c.png","assets/images/slider-images/slider-1.png"],"assets/images/slider-images/slider-1.png"],"./../../public/assets/images/slider-images/slider-2.png":[["slider-2.ca5e6d72.png","assets/images/slider-images/slider-2.png"],"assets/images/slider-images/slider-2.png"],"./../../public/assets/images/slider-images/slider-3.png":[["slider-3.feb118d6.png","assets/images/slider-images/slider-3.png"],"assets/images/slider-images/slider-3.png"],"_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js"}],"../src/script.js":[function(require,module,exports) {
"use strict";
...
var smallImageContainers = document.querySelectorAll(".sm-inner-div");
var bigImageContainer = document.querySelector(".big-img-container");
...
var searchHandler = function searchHandler(e) {
  ...
  var pDataArray = (0, _values.default)(pData);
  var searchValue = e.target.value.trim().toLowerCase();
  if (searchValue.length === 0) {
    searchModal.classList.add("d-none");
    return;
  }
  var filteredArray = pDataArray.filter(function (item) {
    return item.name.toLowerCase().includes(searchValue) || item.brand.toLowerCase().includes(searchValue);
  });
  ...
  filteredArray.forEach(function (item) {
    searchModal.innerHTML += "\n        <li class=\"d-flex flex-row justify-content-between w-100 text-black\">\n          <span class=\"py-1 px-3 text-black fw-normal align-self-end\"> ".concat(item.name, "</span>\n          <span class=\"py-1 px-3 text-black fw-normal align-self-end\">Brand: ").concat(item.brand, "</span>\n        </li>");
  });
};
smallImageContainers.forEach(function (smallImageContainer) {
    ...
    return _regenerator.default.wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return fetch(" https://case-test-8cd5d-default-rtdb.firebaseio.com/products.json");
        case 3:
        ...
        case 8:
          data = _context.sent;
          pData = data;
          smallImageContainers.forEach(function (smallImageContainer, index) {
            return smallImageContainer.innerHTML = "\n  \n      <img id = \"".concat(pData["p".concat(index + 1)].id, "\" src=\"").concat(pData["p".concat(index + 1)].img, "\" class=\"small-img\" />\n      <div class= \"d-flex flex-md-row flex-column justify-content-between px-3 w-100 align-items-center\">\n      <p\n        class=\"fw-bold w-100\"\n      >\n      ").concat(pData["p".concat(index + 1)].name, "\n      </p>\n      <p\n          class=\"py-1 px-3 bg-white text-accent-color rounded-5 fw-normal\"\n          >$").concat(pData["p".concat(index + 1)].price, "\n          </p>\n      </div>\n ");
          });
          bigImageContainer.innerHTML = "\n      <div id=\"".concat(pData["p5"].id, "\" class=\"d-flex flex-row justify-content-between w-100\">\n                  <span\n                    class=\"py-1 px-3 bg-black text-white rounded-5 fw-normal align-self-end\"\n                    >SALE %").concat(pData["p5"].sale * 100, "</span\n                  >\n                  <span\n                    class=\"py-1 px-3 bg-white text-accent-color rounded-5 fw-normal align-self-end\"\n                    >$").concat(pData["p5"].price * pData["p5"].sale, "</span\n                  >\n                </div>\n                <img src=\"").concat(pData["p5"].img, "\" />\n                <p class=\"h3 fw-bold w-100 text-start\">\n                ").concat(pData["p5"].name, "\n                </p>\n                <p class=\"text-start w-100 text-black-50\">Brand: ").concat(pData["p5"].brand, "</p> ");
          _context.next = 18;
          break;
        case 14:
          _context.prev = 14;
          _context.t0 = _context["catch"](0);
          console.error("Hata:", _context.t0);
          _context.t0 = true;
        case 18:
        case "end":
